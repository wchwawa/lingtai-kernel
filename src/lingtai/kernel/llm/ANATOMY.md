...
- `core/psyche/` and `core/soul/` use canonical blocks/interfaces for molt replay and soul-flow consultation (`core/psyche/_molt.py:13`, `core/soul/inquiry.py:15`, `core/soul/consultation.py:196`, `core/soul/consultation.py:347`, `core/soul/consultation.py:498`).
