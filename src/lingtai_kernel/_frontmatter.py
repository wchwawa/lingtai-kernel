...
coding-agent-facing metadata explaining *why* the fragment exists, its purpose,
summary, and audience) followed by the Markdown body that is rendered into the
LLM prompt.
